  ...
  \cventry
    ...
    {Sep. 2022 - Apr. 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        % \item {Helped marketing department improve acquisition strategy using user behavioural data. Created new event triggers which paid affiliates based on sustained activity rather than acquisition. \textbf{Saved over \textsterling30,000 a month} in affiliate costs.}
